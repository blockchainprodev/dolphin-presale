...
export const Footer = () => {
  return (
    <div className="py-[110px] bg-[#2596BE] relative">
      <div className="overflow-hidden absolute top-[-1px] w-full" data-negative="false">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" className="w-full" preserveAspectRatio="none">
          <path
      ...
      <div
        className=" overflow-hidden absolute bottom-[-1px] w-full"
        data-negative="false"
        style={{ transform: 'rotate(180deg)' }}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="w-full" viewBox="0 0 283.5 27.8" preserveAspectRatio="none">
          <path
            className="elementor-shape-fill"
      ...
      <div className="flex justify-center">
        <img src="/assets/IMG_7942-768x768-1-150x150.webp" className="max-w-[150px] h-auto rounded-[300px]" alt="" />
      </div>
      <div className="text-center">
        <h1 className="text-white text-[28px] font-semibold poppins my-3">Contact Us</h1>
        <p className="text-white lato text-[22px]">
          <strong>Have questions or feedback? We’d love to hear from you!</strong>
        </p>
        <span className="block text-white py-5">
          <strong>
            Have questions or feedback? We’d love to hear from you! Reach out to us at
            <span className="text-black">
              &nbsp;
              <a className="text-black" href="mailto:info@dolphinmemetokens.com">
